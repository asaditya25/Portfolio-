...
const contactInfo = [
  {
    icon: EnvelopeIcon,
    title: 'Email',
    value: 'asaditya012345@gmail.com',
  ...
  },
  {
    ...
    title: 'Phone',
    value: '+91 6387269309',
    href: 'tel:+916387269309',
  },
  {
    icon: MapPinIcon,
    title: 'Location',
    value: 'UttarPradesh, Lucknow',
    href: '#',
  },
]
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                ...
                <textarea
                  ...
                  required
                  rows={5}
                  className="w-full px-4 py-3 border border-secondary-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-transparent transition-all duration-200 resize-vertical"
