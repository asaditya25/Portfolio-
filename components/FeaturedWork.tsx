...
const featuredProjects = [
  ...
  },
  {
    ...
    description: 'An intelligent dashboard that provides real-time analytics and insights using machine learning algorithms.',
  ...
  },
  {
    ...
    description: 'A comprehensive tool for managing multiple social media accounts with scheduling, analytics, and content creation features.',
